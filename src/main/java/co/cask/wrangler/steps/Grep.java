...
/**
 * A Wrangle step for 'Grep' like transformations on the column.
 */
public class Grep extends AbstractStep {
  private final String pattern;
  private final String column;

  public Grep(int lineno, String detail, String column, String pattern) {
    super(lineno, detail);
