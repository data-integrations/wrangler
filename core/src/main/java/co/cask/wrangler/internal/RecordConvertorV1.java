...
// */
//public final class RecordConvertorV1 implements Serializable {
//  /**
...
//        try {
//          fields.add(Schema.Field.of(name, Schema.nullableOf(new SimpleSchemaGenerator().generate(value.getClass()))));
...
//        fields.add(
//          Schema.Field.of(name, Schema.nullableOf (Schema.mapOf(Schema.of(Schema.Type.STRING),
//                                                                Schema.of(Schema.Type.STRING))))
//        );
//      }
//
//      if (value instanceof JsonElement) {
//        fields.add(Schema.Field.of(name, toSchema(name, (JsonElement) value)));
//      }
//    }
...
//  }
//
//  public Schema toSchema(String name, JsonElement value) throws RecordConvertorException {
//    List<Schema.Field> fields = new ArrayList<>();
//    if (value instanceof JsonObject) {
//      List<Schema.Field> flds = toSchema(name, value.getAsJsonObject());
//      Schema.recordOf("dfjnfsj", fields);
//      fields.addAll(toSchema(name, value.getAsJsonObject()));
//    } else if (value instanceof JsonArray) {
//      fields.addAll(toSchema(value.getAsJsonArray()));
//    } else if (value instanceof JsonPrimitive) {
//      fields.addAll(toSchema(name, value.getAsJsonPrimitive()));
//    }
//    return Schema.recordOf(name, fields);
//  }
//
//  private List<Schema.Field> toSchema(String name, JsonObject object) throws RecordConvertorException {
...
//      fields.addAll(toSchema(key, child);
//    }
//    return fields; Lists.newArrayList(Schema.Field.of("record", Schema.recordOf("dfjnfsj", fields)));
//  }
//
//  private List<Schema.Field> toSchema(JsonArray array) throws RecordConvertorException {
//    List<Schema.Field> fields = new ArrayList<>();
...
//  }
//
//  private List<Schema.Field> toSchema(String name, JsonPrimitive primitive) throws RecordConvertorException {
//    List<Schema.Field> fields = new ArrayList<>();
