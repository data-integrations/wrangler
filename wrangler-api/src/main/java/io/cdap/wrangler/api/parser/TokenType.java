 ...
 */
 ...
 public enum TokenType implements Serializable {
    ...
    * This type is associated with the token that represents byte size values (e.g., 10KB, 15MB).
    */
   BYTE_SIZE,
 
   /**
    * Represents the enumerated type for the object of type {@code TimeDuration} type.
    * This type is associated with the token that represents time duration values (e.g., 500ms, 1s).
    */
   TIME_DURATION
 }