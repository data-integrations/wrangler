...
public enum TokenType implements Serializable {
   ...
   * This type is associated with the token that represents a byte size in a human-readable format.
   * E.g. "10MB", "2GB", etc.
   */
  BYTE_SIZE,
   ...
   * This type is associated with the token that represents a time duration in a human-readable format.
   * E.g. "10s", "2m", "1h", etc.
   */
  TIME_DURATION,
}
