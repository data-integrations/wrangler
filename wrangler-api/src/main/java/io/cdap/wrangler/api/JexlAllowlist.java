  ...
  public static final class JexlAllowlistDeserializer implements JsonDeserializer<JexlAllowlist> {
    ...
    public JexlAllowlist deserialize(JsonElement allowlistJson, Type typeOfT, JsonDeserializationContext ctx)
      ...
      return new JexlAllowlist(
          ...
          deserializeProperty(allowlistJsonObject, METHODS_KEY, new TypeToken<List<String>>() {
          }.getType(), Collections.emptyList(), ctx),
          deserializeProperty(allowlistJsonObject, PROPERTIES_KEY, new TypeToken<List<String>>() {
          }.getType(), Collections.emptyList(), ctx));
    }

    @Nonnull
    private static <T> T deserializeProperty(
        JsonObject obj, String key, Type type, @Nonnull T defaultValue, JsonDeserializationContext ctx) {
