...
/**
 * The TimeDuration class represents a duration of time in various units (e.g., seconds, milliseconds).
 * It provides methods to convert and manipulate time durations.
 */
