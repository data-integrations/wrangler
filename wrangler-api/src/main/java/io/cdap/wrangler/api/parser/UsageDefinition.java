 ...
 * name of the directive itself. Each token specification has an associated
 * ordinal that can be used to position the argument within the directive.
 *
 * Following is a example of how this class can be used.  <code>
...
public final class UsageDefinition implements Serializable {
     ...
     * <code>UsageDefinition</code> object is created.
     *
    ...
    /**
     * This method returns the list of <code>TokenDefinition</code> that should
     * be used for parsing the directive into <code>Arguments</code>.
     *
    ...
    /**
     * Returns the count of <code>TokenDefinition</code> that have been
     * specified as optional in the <code>UsageDefinition</code>.
     *
     ...
     * for this directive. It inspects all the tokens to generate a standard
     * syntax for the usage of the directive.
     *
     ...
     * <code>UsageDefinition</code> object. In order to create a
     * <code>UsageDefinition</code>, a builder has to created.
     *
     * <p>
     * This builder is provided as user API for constructing the usage
     * specification for a directive.</p>
     *
     * @param directive name of the directive for which the builder is created
     * for.
     * @return A <code>UsageDefinition.Builder</code> object that can be used to
     * construct <code>UsageDefinition</code> object.
     */
     ...
     * <code>UsageDefinition</code> object. It exposes different methods that
     * allow users to configure the <code>TokenDefinition</code> for each token
     * used within the usage of a directive.
     */
    public static final class Builder {
        ...
        /**
         * This method provides a way to set the name and the type of token,
         * while defaulting the label to 'null' and setting the optional to
         * FALSE.
         *
        ...
        /**
         * Allows users to define a token with a name, type of the token and
         * additional optional for the label that is used during creation of the
         * usage for the directive.
         *
         * @param name of the token in the definition of a directive.
         * @param type of the token to be extracted.
        ...
        /**
         * Method allows users to specify a field as optional in combination to
         * the name of the token and the type of token.
         *
         * @param name of the token in the definition of a directive.
         * @param type of the token to be extracted.
        ...
        /**
         * Method allows users to specify a field as optional in combination to
         * the name of the token, the type of token and also the ability to
         * specify a label for the usage.
         *
         * @param name of the token in the definition of a directive.
         * @param type of the token to be extracted.
         * @param label label that modifies the usage for this field.
