...
public final class UsageDefinition implements Serializable {
  ...
  public static final class Builder {
    ...
    public Builder byteSize(String name) {
      tokens.add(new TokenDefinition(name, TokenType.BYTE_SIZE, null, currentOrdinal++, false));
      return this;
    }

    public Builder timeDuration(String name) {
      tokens.add(new TokenDefinition(name, TokenType.TIME_DURATION, null, currentOrdinal++, false));
      return this;
    }
