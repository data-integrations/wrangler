...
public class TimeDurationTest {
  ...
  public void testParsing() {
    ...
    Assert.assertEquals(105, td4.convertTo(TimeUnit.MINUTES));
  ...
  public void testStaticMethods() {
    // Test fromNanos()
    TimeDuration tdNanos = TimeDuration.fromNanos(1_000_000_000);
    Assert.assertEquals(1_000_000_000, tdNanos.getNanoseconds());
    Assert.assertEquals(TimeUnit.NANOSECONDS, tdNanos.getUnit());
    
    // Test fromMillis()
    TimeDuration tdMillis = TimeDuration.fromMillis(1000);
    Assert.assertEquals(1000, tdMillis.getMilliseconds());
    Assert.assertEquals(TimeUnit.MILLISECONDS, tdMillis.getUnit());
    ...
    Assert.assertEquals(5000, parsed.getMilliseconds());
  }

  @Test
  public void testFormat() {
    TimeDuration td = new TimeDuration(2.5, TimeUnit.SECONDS);
  ...
  public void testTokenInterface() {
    ...
    Assert.assertEquals(5400000000000L, json.get("nanos").getAsLong());
  }
} 
