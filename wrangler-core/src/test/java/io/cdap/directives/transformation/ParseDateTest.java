...
public class ParseDateTest {
  ...
  public void testSimpleDateWithPatterns() throws Exception {
    ...
    Assert.assertEquals("12-10-2016 at 22:45:11 UTC", rows.get(0).getValue("date7"));
    Assert.assertEquals("10/12/16 06:45:11", rows.get(0).getValue("date8"));
    Assert.assertEquals("2016,12.10T22:45:11.111+0000", rows.get(0).getValue("date9"));
    ...
    Assert.assertEquals("2016.12.10 AD at 22:45:11 UTC", rows.get(0).getValue("date15"));
  }
