...
class MockArguments implements Arguments {
    ...
    @Override public void set(String key, Object value) { args.put(key, value); }
    @Override public Map<String, Object> values() { return Collections.unmodifiableMap(args); }
    @Override public String toString() { return args.toString(); }
}