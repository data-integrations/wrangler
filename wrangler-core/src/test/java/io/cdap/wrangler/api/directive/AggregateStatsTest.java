...
public class AggregateStatsTest {
    ...
    public void testWithMissingColumns() throws DirectiveParseException {
        ...
        when(args.value("source-size-column")).thenReturn(null);
        when(args.value("source-time-column")).thenReturn(null);
        when(args.value("target-size-column")).thenReturn(null);
        when(args.value("target-time-column")).thenReturn(null);
