...
public class HL7ParserTest {
  ...
  // Admit a patient.
  String adt_a01 = "MSH|^~\\&|HIS|RIH|EKG|EKG|199904140038||ADT^A01||P|2.2\r"
  ...
  // Update patient info.
  String adt_08 = "MSH|^~\\&|ADT|CHMC|ProAccess||20230822181701||ADT^A08|MT142756636134091|P|2.3|||AL|NE\r" +
  ...
  // Register a patient.
  String adt_04 = "MSH|^~\\&|SENDING_APPLICATION|SENDING_FACILITY|RECEIVING_APPLICATION|RECEIVING_FACILITY|20110613083617||ADT^A04|934576120110613083617|P|2.3||||\r" +
  ...
  // Success
  String success = "MSH|^~\\&|SENDING_APPLICATION|SENDING_FACILITY|RECEIVING_APPLICATION|RECEIVING_FACILITY|20110614075841||ACK|1407511|P|2.3||||||\r" +
    "MSA|AA|1407511|Success||";

  // Error
  String error = "MSH|^~\\&|SENDING_APPLICATION|SENDING_FACILITY|RECEIVING_APPLICATION|RECEIVING_FACILITY|20110614075841||ACK|1407511|P|2.3||||||\r" +
  ...
  String orders = "MSH|^~\\&|SendingApp|SendingFac|ReceivingApp|ReceivingFac|20120411070545||ORM^O01|59689|P|2.3\r" +
    "PID|1|12345|12345^^^MIE&1.2.840.114398.1.100&ISO^MR||MOUSE^MICKEY^S||19281118|M|||123 Main St.^^Lake Buena Vista^FL^3283|||||||||||||||||||\r" +
    "PV1|1||7^Disney^Walt^^MD^^^^|||||||||||||||||||||||||||||||||||||||||||||||^^^^^1.2.840.114398.1.668.11999116110119971081089799101||\r" +
    ...
    "ORC|NW|23|||Pending||^^^^^0||20150325170228|26^David^Dave||8^Selenium^Selenium|^^^^OFFICE^^^^^Office|^^^test@email.com||||||||||\r" +
  ...
  String results = "MSH|^~\\&|SendingApp|SendingFac|ReceivingApp|ReceivingFac|201607060811||ORU^R03|5209141|D|2.3\r" +
    "PID|1|123456|123456||SPARROW^JACK^||19600101|M|||123 BLACK PEARL^^DETROIT^MI^48217||3138363978|||||1036557|123456789\r" +
    "PV1|||^^\r" +
    "ORC|RE||161810162||||00001^ONCE^^^^||201607060811|||00007553^PHYSICIAN^RICHARD^ ^^^|||||||||BIOTECH CLINICAL LAB INC^^23D0709666^^^CLIA|25775 MEADOWBROOK^^NOVI^MI^48375|^^^^^248^9121700|OFFICE^1234 MILE ROAD  SUITE # 2^ROYAL OAK^MI^48073\r" +
    "OBR|8|455648^LA01|1618101622^GROUP951|GROUP951^CHROMOSOMAL ANALYSIS^L|||201606291253|||||||201606291631||00007553^PHYSICIAN^RICHARD^ ^^^||||||201607060811|||F||1^^^^^9\r" +
    "OBX|1|ED|00008510^INTELLIGENT FLOW PROFILE^L||^^^^...T0YK||||||C|||201606291631\r" +
  ...
  String nte = "MSH|^~\\&|SendingApp|SendingFac|ReceivingApp|ReceivingFac|20150323144246||ORU^R01|91734|P|2.3\r" +
    ...
    "PV1|1|O|1893^^^ZHIE||||4098^Physician^Sheldon|4098^Physician^Sheldon|||||||||4098^Physician^Sheldon|R||||||||||||||||||||||||||201503201114\r" +
    "ORC|RE|528527425|56083|||||||||4098^Physician^Sheldon^A\r" +
    "OBR|1|528527425|CTG150000145|LAB6460^Gene Bone Marrow||201503201114|201503231500|||||||201503231629||4098^Physician^Sheldon^^^^MD||||||201503231637||CTG|F||1\r" +
  ...
  public void testBasic() throws Exception {
    String[] directives = new String[] {
      "parse-as-hl7 body",
      "parse-as-json body.hl7",
      "keep body.hl7.MSH",
      "parse-as-json body.hl7.MSH"
    };
