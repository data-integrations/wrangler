...
public final class NumberFunctions {
  ...
  /**
   * @return Returns the mantissa from the given decimal.
   */
  public static double MantissaFromDecimal(BigDecimal value) {
    int exponent = Math.getExponent(value.doubleValue());
    return value.doubleValue() / Math.pow(2, exponent);
  }
