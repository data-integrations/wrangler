   ...
   public <E extends Exception> void walk(String recipe,
     ...
     while (tokenGroups.hasNext()) {
       ...
       for (int i = 1; i < tokenGroup.size(); i++) {
         TokenType tokenType = tokenGroup.get(i).type();
         if (tokenType == TokenType.BYTE_SIZE) {
           System.out.println("BYTE_SIZE token found: " + tokenGroup.get(i).value());
           // Add logic to process BYTE_SIZE tokens here
         } else if (tokenType == TokenType.TIME_DURATION) {
           System.out.println("TIME_DURATION token found: " + tokenGroup.get(i).value());
           // Add logic to process TIME_DURATION tokens here
         }
       }
