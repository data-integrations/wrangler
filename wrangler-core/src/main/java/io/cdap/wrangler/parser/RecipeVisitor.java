 ...
 */
 ...
 public final class RecipeVisitor extends DirectivesBaseVisitor<RecipeSymbol.Builder> {
   ...
   /**
    * Processes the 'value' rule which can contain String, Number, Column, Bool,
    * ByteSize, or TimeDuration tokens. This method extracts the appropriate token
    * based on the context.
    *
    * @param ctx The parsing context for the value rule.
    * @return The updated RecipeSymbol.Builder with the token added.
    */
   @Override
