...
/**
 * The {@code AggregateStats} class is a directive that aggregates statistical data
 * such as total size and total time from the input rows and produces a summary row.
 */
