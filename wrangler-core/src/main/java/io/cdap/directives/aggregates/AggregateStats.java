...
/**
 * The AggregateStats directive performs aggregation over ByteSize and TimeDuration columns.
 * It calculates total and average values based on the column type.
 */
public class AggregateStats implements Directive {
  ...
  private String name = "aggregatesStats";
