...
public class AggregateSizeAndTime implements Directive {
    ...
    public UsageDefinition define() {
        return UsageDefinition.builder(NAME)
                ...
                .addOptionalArg("output_size_unit", TokenType.BYTE_SIZE) // B, KB, MB, GB
                .addOptionalArg("output_time_unit", TokenType.TIME_DURATION) // ms, s, m
                .build();
    }
    ...
    public List<Row> execute(Row row, ExecutorContext context) {
        ...
        return Collections.emptyList(); // No output until finalization
    }
