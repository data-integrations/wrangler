...
/**
 * A parser for time duration strings that supports various units (ms, s, m, h).
 * This class parses string representations of time durations and provides methods to access and format time values.
 */
