...
public class TextMetricMeasure implements Directive {
  ...
  public List<FieldTransformOperation> getFieldOperations(StageContext context) {
    return ImmutableList.of(
      new FieldTransformOperation(String.format("Measure metrics generated column %s", destination),
                                  String.format("Measure metrics generated column %s between columns %s and %s",
                                                destination, column1, column2),
                                  Arrays.asList(column1, column2), destination),
      new FieldTransformOperation(String.format("Measure metrics using %s", column1),
                                  String.format("Measure metrics using %s", column1),
                                  Collections.singletonList(column1), column1),
      new FieldTransformOperation(String.format("Measure metrics using %s", column2),
                                  String.format("Measure metrics using %s", column2),
