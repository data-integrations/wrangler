...
/**
 * A Step to extract XML attribute as JSON array through XPath.
 */
@Usage(
  directive = "xpath-array-attr",
  usage = "xpath-array-attr <column> <destination> <xpath>",
  description = "Extract XML attribute as JSON array using XPath"
)
public class XPathArrayAttr extends AbstractStep {
